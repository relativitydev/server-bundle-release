# Configure Extensibility and Integrations
...
- [Setting Up RabbitMQ Integration](./ew-extensibility-configuration-01-rabbitmq.md)
...
- [Setting Up OpenTelemetry Java Agent for Relativity Analytics Engine](./ew-extensibility-configuration-02-caat.md)
...
- [Elasticsearch Retention Policy Guidelines](./ew-extensibility-configuration-03-retention-policy.md)

### IIS Configuration

Configuring IIS log fields required for proper log ingestion by Environment Watch.

- [Setting Up IIS configuration](./ew-extensibility-configuration-04-iis.md)
...
- [Setting Up Elasticsearch Configuration](./ew-extensibility-configuration-05-elastic-field-limit.md)
...
[Click here for the next step](../../elastic-stack-setup-04-post-install-verification/elastic-stack-setup-04-post-install-verification.md)