...
- If Windows service fails to start is likely due to a configuration or environmental problem
  ...
  Verify kibana configuration by following ![elasticsearch_setup](/docs/elasticsearch_setup.md)
...
If Windows service fails to start is likely due to a configuration or environmental problem
     ...
     Verify apm configuration by following ![elasticsearch_setup](/docs/elasticsearch_setup.md)
...
![](/resources/troubleshooting-images/apm-serviceissue.png)
