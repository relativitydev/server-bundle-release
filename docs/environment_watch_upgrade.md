...
3. The CLI will detect that setup has already been performed. Select the **Upgrade** option to proceed.
...
4. The CLI will retrieve the existing settings and perform the upgrade. Please wait for the process to finish.
...
1. Install the Upgraded Monitoring Agent
...
4. Repeat Installation for other servers. 
