...
### Step 1: Download and Install Elasticsearch 8.17.3/9.1.3 on one server
1. Download Elasticsearch 8.17.3/9.1.3
...
2. Install and Configure Elasticsearch 8.17.3/9.1.3
...
8. Install the 'mapper-size' plugin
...
3. Configure APM Server (`C:\apm-server-x.x.x-windows-x86_64\apm-server.yml`)
