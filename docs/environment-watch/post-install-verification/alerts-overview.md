# [Relativity] Alerts Overview Dashboard Post-Install Verification
...
- [Verify Dashboard Time Range](#verify-dashboard-time-range)  
...
**Screenshot:**  
![Screenshot: Dashboard listed in Kibana](./screenshots/dashboard-listed.png)
...
**Screenshot:**  
![Screenshot: Dashboard tag](./screenshots/dashboard-tag.png)
...
- All indicators include:
  ...
  - Color: Green, Red, or Gray based on alert state.

**Screenshot:**  
![Screenshot: Health indicators at top](./screenshots/health-indicators-overview.png)
...
**Important Note:** If any health indicator shows as Gray or displays "N/A", this indicates an issue with data collection or service initialization. All health indicators should display either Green or Red status after the initial wait period. If you see Gray/N/A status, verify that:
1. You have waited the full 10–15 minutes after installation
2. All related services are running properly
3. Data collection is functioning correctly

**Example Screenshot:**  
![All Health Indicators](./screenshots/all-health-indicators.png)

---

## Verify Dashboard Time Range

**Description:**  
Ensure that the dashboard is using a custom 10-minute time range as required for health indicators.
...
4. Set the range to the **last 10 minutes**.
5. Apply changes.

**Expected Result:**
- The time range reflects the last 10 minutes.
- Health indicators update dynamically based on this range.

**Screenshot:**  
![Screenshot: Time range 10 minutes](./screenshots/time-range-10-minutes.png)
...
**Steps:**
1. For each health indicator tile:
   - Right-click and inspect properties (if needed).
2. Check for the following attributes:
   - Font color is **Black** (default).
   - Font size is default.
   - **No decimal values** are used (set to 0).
   - Color mapping is set to:
     - **Color by value → Dynamic**
     - Supporting visualization: **Type = None**
   - Subtitle appears using **"Titles and Text"** setting (e.g., *Healthy Alerts*).
...
**Screenshot:**  
![Screenshot: Visualization settings](./screenshots/visualization-style.png)
